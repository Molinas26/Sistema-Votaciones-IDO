        ...
        <div class="mobile-screen2">
            ...
            <form method="POST" action="<?php echo e(route('register')); ?>">
                ...
                <div style="width: 45%;float: left;margin-left: 5%">
                  <input  type="text" name="name" required max="40" placeholder="Nombre Completo" class="<?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
                ...
                <div style="width: 45%;float: left;margin-left: 5%">
                  <input  type="text" name="user" required max="20" placeholder="Nombre de Usuario" class="<?php $__errorArgs = ['user'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
</html><?php /**PATH C:\laragon\www\Sistema-votacion-IDO\resources\views/auth/registerP.blade.php ENDPATH**/ ?>